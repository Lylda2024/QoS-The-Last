...
import { RestSite, SiteService } from './site.service';

const requireRestSample: RestSite = {
  ...sampleWithRequiredData,
  dateMiseEnService: sampleWithRequiredData.dateMiseEnService?.format(DATE_FORMAT),
  dateMes2G: sampleWithRequiredData.dateMes2G?.format(DATE_FORMAT),
  dateMes3G: sampleWithRequiredData.dateMes3G?.format(DATE_FORMAT),
};
