...
public class TypeUtilisateurResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TypeUtilisateurDTO>> getAllTypeUtilisateurs(TypeUtilisateurCriteria criteria) {
        LOG.debug("REST request to get TypeUtilisateurs by criteria: {}", criteria);

        List<TypeUtilisateurDTO> entityList = typeUtilisateurQueryService.findByCriteria(criteria);
