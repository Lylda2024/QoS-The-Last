...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.orange.qos.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.orange.qos.repository.UserRepository.USERS_BY_EMAIL_CACHE);
